...
class Display:
    ...
    def __init__(self):
        ...
        self.title = pygame.display.set_caption("Help MacGyver !")
        ...
        self.counter_text = self.items_font.render("inventory : 0", True,
                                                   pygame.Color("#14e0e3"))
        # Event win/loose font and text
        self.wl_font = pygame.font.Font(None, 50)
        self.win_text = self.wl_font.render("YOU WIN",
                                            True, pygame.Color("#b905fa"))
        self.loose_text = self.wl_font.render("YOU lOOSE",
                                              True, pygame.Color("#f22c05"))
